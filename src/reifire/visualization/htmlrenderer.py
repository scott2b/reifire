...
from .processor import VisualizationProcessor, VisualizationComponent, VisualizationConnection
...
class HTMLRenderer:
    ...
    def __init__(self, template_dir: Optional[Path] = None):
        ...
        self.env = Environment(
            ...
            lstrip_blocks=True  # Remove leading spaces and tabs from the start of a line
        )
    ...
    def render(self, data: Dict[str, Any], output_file: Optional[Path] = None) -> str:
        ...
        Args:
            ...
            output_file: Optional output file path. If not absolute, will be relative to current directory.
        ...
        template_data = {
            ...
            "metadata": {
                ...
                "visualization_config": data.get("metadata", {}).get("visualization_config", {})
            }
        }
    ...
    def _connection_to_dict(self, connection: VisualizationConnection) -> Dict[str, Any]:
